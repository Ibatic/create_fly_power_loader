...
public class CLoader extends ConfigBase {
    ...
    private static class Comments {
        ...
        static String enableStation = "Whether the chunk loader functions when attached to train stations. Uses each loader's own configured range (the brass loader's scroll-wheel setting; the andesite loader is always 1 chunk)";
    }
}
