...
public class EmptyChunkLoaderScenes {
    public static void usage(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().createEntity(w -> {
            Ghast ghastEntity = EntityTypes.GHAST.create(w, EntitySpawnReason.TRIGGERED);
        ...
        scene.overlay()
                ...
                .withItem(new ItemStack(CPLBlocks.EMPTY_ANDESITE_CHUNK_LOADER));
        scene.idle(10);
        ...
        scene.overlay()
                .showControls(util.vector().centerOf(center.above(4)), Pointing.DOWN, 40).rightClick()
                .withItem(new ItemStack(CPLBlocks.EMPTY_BRASS_CHUNK_LOADER));
        scene.idle(50);
